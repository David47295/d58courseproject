...
tshark -r univ1_pt3 -n -T fields -e ip.src -e tcp.srcport -e ip.dst -e tcp.dstport -e tcp.hdr_len -e tcp.len -e ip.hdr_len -e frame.len -e frame.time_epoch -e tcp.flags -e tcp.analysis.ack_rtt -e tcp.analysis.retransmission -Y tcp -E header=y -E occurrence=f -E separator=, > univ1_pt3_tcp.csv
